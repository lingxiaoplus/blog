...
public class OssFileServiceImpl implements OssFileService {
    ...
    @Override
    public List<OssFileInfo> getFileList(String filePrefix, int limit) {
        List<OssFileInfo> fileList = uploadUtil.getFileList(filePrefix, limit);
    ...
    public OssProperties getOssProperties() {
        return uploadUtil.getOssProperties();
    }
